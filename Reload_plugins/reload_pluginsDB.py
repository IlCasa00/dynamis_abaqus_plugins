...
dialogBox = RsgDialog(title='Reload plugins', kernelModule='Reload_plugins', kernelFunction='reload_plugins', includeApplyBtn=False, includeSeparator=True, okBtnText='OK', applyBtnText='Apply', execDir=execDir)
dialogBox.show()